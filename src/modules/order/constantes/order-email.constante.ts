        ...
        COMPLETED: {
            ...
            content: type === 'customer' ?
                [
                    ...
                    emailComponentsService.Quote('Un grand merci pour votre confiance et à très bientôt pour de nouvelles saveurs !', 'L\'équipe Ambassade Tchad'), // Using Quote for a closing message
                ].join('\n') :
                [
                    emailComponentsService.Greeting(`Bonjour ${orderData.restaurant_name}`, '✅'),
