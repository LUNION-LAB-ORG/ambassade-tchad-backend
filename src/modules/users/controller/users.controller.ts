...
export class UsersController {
    ...
    @ApiCreatedResponse({
        ...
        schema: {
            properties: {
                ...
                generatedPassword: {
                    type: 'string',
                    description: 'Mot de passe initial généré (à communiquer au nouvel utilisateur)'
                },
            },
        },
    })
    ...
    demandeurDetail(@Param('id') userId: string): Promise<Omit<User, 'password'>> {
        return this.usersService.demandeurDetail(userId);
    }
    ...
    @ApiOperation({summary: 'Mettre à jour le mot de passe d\'un utilisateur demandeur'})
    @ApiOkResponse({
        description: 'Mot de passe utilisateur mis à jour avec succès.',
        schema: {type: 'object'},
    })
    @ApiBadRequestResponse({
        description: 'Données de mise à jour invalides.',
    ...
    async updatePassword(
        ...
        return this.usersService.updateDemandeurPassword(req, id, updateUserPasswordDto);
    }
