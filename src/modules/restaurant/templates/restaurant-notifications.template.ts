...
export class RestaurantNotificationsTemplate {
    ...
    NEW_RESTAURANT_BACKOFFICE: NotificationTemplate<{
        ...
        restaurant: Restaurant
            ...
            message: (ctx) => `${ctx.data.restaurant.name} a été créé par ${ctx.data.actor.fullname} (${userGetRole(ctx.data.actor.role)}). Une belle addition à Ambassade Tchad !`,
    ...
    WELCOME_RESTAURANT: NotificationTemplate<{
        ...
        restaurant: Restaurant
            ...
            message: (ctx) => `Votre restaurant fait maintenant officiellement partie de la famille Ambassade Tchad ! Prêt à recevoir vos premières commandes ?`,
