...
export class EmailPreviewController {
        ...
        switch (componentName) {
            ...
            case ComponentName.RestaurantInfo:
                ...
                componentHtml = this.emailComponentsService.RestaurantInfo('Détails du Restaurant', [
                    { label: 'Nom', value: 'Ambassade Tchad' },
            ...
            case ComponentName.CtaButton:
                ...
                componentHtml = this.emailComponentsService.CtaButton('Visiter notre site', 'https://www.ambassade-tchad.com', '🚀');
                break;
            ...
            case ComponentName.Quote:
                ...
                componentHtml = this.emailComponentsService.Quote('La nourriture est notre passion, et le poulet, notre spécialité !', 'L\'Équipe Ambassade Tchad');
                break;
            ...
            case ComponentName.HeroSection:
                ...
                componentHtml = this.emailComponentsService.HeroSection('Bienvenue chez Ambassade Tchad !', 'Votre destination pour le meilleur poulet.', AssetsImages.banner.url);
                break;
    ...
    private generateAllComponentsHtml(): string {
      ...
      <p>Cette page présente tous les composants d'email disponibles avec le thème Ambassade Tchad.</p>

      <h2>COMPOSANT : HEADER</h2>
      ${components.Header(this.AMBASSADE_TCHAD_LOGO, "", this.AMBASSADE_TCHAD_DESCRIPTION)}
      ${components.Divider()}
      ...
      ${components.CtaButton('Suivre votre commande', 'https://www.ambassade-tchad.com/tracking', '🚚')}
      ${components.Divider()}
      ...
      ${components.Button('Commander Maintenant', 'https://www.ambassade-tchad.com/order', 'primary', 'lg')}
      ${components.Button('En savoir plus', 'https://www.ambassade-tchad.com/about', 'secondary')}
      ...
      ${components.SocialLinks(this.AMBASSADE_TCHAD_SOCIAL_LINKS)}
      ${components.Divider()}
